...
install() {
    ...
    case $choose in
    1)
        wget https://github.com/MINErpRroxY/MinerProxy.git -O /root/miner_proxy/minerProxy
        ;;
    *)
        echo "请输入数字1"
        ;;
    ...
    wget https://raw.githubusercontent.com/MINErpRroxY/MinerProxy/main/install.sh -O /root/miner_proxy/install.sh
    chmod 777 /root/miner_proxy/install.sh
    echo "如果没有报错则安装成功"
    echo "正在启动..."
